...
<div class="container mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="card-body">
            ...
            <button class="btn btn-circle" on:click={() => counter--}>-</button>
    ...
    <div class="flex flex-col gap-4">
        ...
        <button class="btn btn-info" on:click={addNotification}>
            Add Notification
        </button>
        <button class="btn btn-warning" on:click={simulateLoading}>
